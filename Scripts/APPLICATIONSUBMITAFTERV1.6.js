...
| Action# : N/A
|
| Notes   :  Added address variables to script --  KK 05/28/2014
|            Added function GetOwnersByParcel() -- KK 05/28/2014
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
if(parcels.getSuccess())
{
	 ...
	 {
	   	logDebug("There is no any parcel for the cap.");
	 }
	 else
	 {
	    ...
	    for (var i =0; i< parcels.length; i++)
	    {
				...
				if (parcelOwnersResult.getSuccess())
				{
						...
						logDebug("Successfully get owner(s) by Parcel "+actuallyParcelNumber+". Detail as follow:");
						var ownerArr = parcelOwnersResult.getOutput();
						logDebug("Size :" + ownerArr.length);
