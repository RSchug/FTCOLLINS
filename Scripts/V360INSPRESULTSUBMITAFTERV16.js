/*------------------------------------------------------------------------------------------------------/
| SVN $Id: V360InspectionResultSubmitAfterV1.6.js 1051 2007-12-18 17:58:36Z john.schomp $
| Program : V360InspectionResultSubmitAfterV1.6.js
...
| Action# : N/A
|
| Notes   : Changed inspComment to inspResultComment to match InspectionResultSubmitAfter script
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
function copyParcels(pFromCapId, pToCapId)
	...
	for (xx in inspList)
		...
		if ("Insp Scheduled"==inspList[xx].getDocumentDescription())
			...
			inspResultComment = inspList[xx].getInspectionComments();
			schedRes = aa.inspection.scheduleInspection(vToCapId, inspector, inspDate, inspTime, inspType, inspResultComment);
