/*------------------------------------------------------------------------------------------------------/
| Program: ExpireIssuedPermitsRevBatch  Trigger: Batch    Client : Spokane   SAN# : 06SSP-00242
| 
| SPOKANE 06SSP-00242
|                                                                       
...
| Version 0.4 - Only expire permit if it is in Issued Rev Status		02/20/2008 - Kristi Kreisher
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
|
...
var validStatus = "Issued Rev"			// Valid app status to change to expire
...
if (ASIResult.getSuccess())
	...
	for (ii in ASIArray)
		...
		if (capStatus && capStatus.equals(validStatus))
